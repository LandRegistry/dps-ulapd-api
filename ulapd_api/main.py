...
from ulapd_api.blueprints import register_blueprints
from ulapd_api.exceptions import register_exception_handlers
from ulapd_api.extensions import register_extensions
