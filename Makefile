...
unittest:
	if [ -z ${report} ]; then py.test unit_tests; else py.test --html=test-output/report.html --junitxml=test-output/unit-test-output.xml --cov-report=html:test-output/unit-test-cov-report unit_tests; fi
